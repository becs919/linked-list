...
//
// var isUrlValid = $('.website-url-input').val();
// if(/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/|www\.)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/.test(isUrlValid){
//     appendRightSide();
// } else {
//     alert("invalid url");
// }
...
// //     console.log('HIIIIII');
// // } else if (!$isValid) {
// //   alert('ERROR: url is not valid format')
// // } else {
// //   appendRightSide();
// // };
